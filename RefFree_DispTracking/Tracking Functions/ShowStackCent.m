...
function ShowStackCent(InputStack,subpixMaxima) %,centroids
...
%         'Callback',@plotCircles);
    ...
    imshow(InputStack(:,:,1),[])
    hold on    
    scatter(subpixMaxima(:,1,1),subpixMaxima(:,2,1))
    hold off
    ...
    function XListenerCallBack
        ...
        hold on    
        scatter(subpixMaxima(:,1,CurrentFrame),subpixMaxima(:,2,CurrentFrame))
        hold off
