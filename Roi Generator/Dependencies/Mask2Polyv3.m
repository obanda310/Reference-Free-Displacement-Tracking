function [poly1, poly2, poly3] = Mask2Polyv3(raw)
xsize = size(raw,2);
ysize = size(raw,1);
...
rawN2 = bwareaopen(rawN, round(xsize/50)^2);
...
%% Update 'raw'
IM2 = (raw.*DivMask); %Update 'raw' image by convolution with DivMask
