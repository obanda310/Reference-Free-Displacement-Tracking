%This code is designed to process and detect collagen fibril cross-sections
%for analysis of fibril physical properties. Written by Omar A. Banda
%05/29/2017. Depedendancies include: getImages(OAB),ShowStack(OAB),
%bpass(Maria Kilfoil's lab),and the image processing toolbox 
...
image6 = images2/50;
image7 = image6<prctile(mean(image6),99.9);

%% Fill small holes
se = strel('disk',9);
clear image9 image8
imagesBigHoles = bwareaopen(image7==0,50);
imagesSmallHoles = image7==0 & ~imagesBigHoles;
image9 = image7|imagesSmallHoles;

image8 = imerode(image9,se);
imagesBigHoles = bwareaopen(image8==0,2000);
imagesSmallHoles = image8==0 & ~imagesBigHoles;
image9_2 = image9|imagesSmallHoles;
...
image10g = imgaussfilt(image10,10);
image10i = image10g;
