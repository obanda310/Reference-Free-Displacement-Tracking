...
h.c(5) = uicontrol('style','checkbox','units','pixels',...
    'position',[10,130,300,15],'string','Transmitted/Trajectory Quiver Overlays with Save');
...
h.c(9) = uicontrol('style','checkbox','units','pixels',...
    'position',[10,170,300,15],'string','PillarFit');
h.c(10) = uicontrol('style','checkbox','units','pixels',...
    'position',[10,190,300,15],'string','PlaneFit');
