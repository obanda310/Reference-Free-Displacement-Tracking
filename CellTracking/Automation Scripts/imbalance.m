...
totals(1,1) = abs(sum(shear.ltLastdX .* shear.coCheck2));
totals(1,3) = abs(sum(shear.ltLastdY .* shear.coCheck2));
totals(1,2) = sum(abs(shear.ltLastdX .* shear.coCheck2));
totals(1,4) = sum(abs(shear.ltLastdY .* shear.coCheck2));
...
totals(1,5) = abs(sum(Zdisp));
totals(1,6) = sum(abs(Zdisp));
