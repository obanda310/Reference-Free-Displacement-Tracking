...
if auto == 1
    ...
    h.c(3) = uicontrol('style','checkbox','units','pixels',...
        'position',[10,150,300,15],'string','DEBUGGING:Plotting Corrected X,Y Coordinate Fields','Value',0);
    ...
    h.c(5) = uicontrol('style','checkbox','units','pixels',...
        'position',[10,90,300,15],'string','Transmitted/Trajectory Quiver Overlays with Save','Value',0);
