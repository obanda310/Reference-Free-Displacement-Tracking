...
h.f = figure('units','pixels','name','Select Outputs','position',[800,480,300,150],...
...
h.c(3) = uicontrol('style','checkbox','units','pixels',...
                'position',[10,70,300,15],'string','DEBUGGING:Plotting Corrected X,Y Coordinate Fields');
h.c(4) = uicontrol('style','checkbox','units','pixels',...
                'position',[10,90,300,15],'string','Centroids on Black Background');
h.c(5) = uicontrol('style','checkbox','units','pixels',...
                'position',[10,110,300,15],'string','Transmitted/Trajectory Quiver Overlays with Save');
h.c(6) = uicontrol('style','checkbox','units','pixels',...
                'position',[10,130,300,15],'string','Transmitted/Trajectory Quiver Overlays without Save');            
